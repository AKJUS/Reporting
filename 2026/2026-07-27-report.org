#+title:  Weekly report for 20th of July to 27th of July 2026
...
- Good progress from GSoC students
- Working on important bits of the type system such as unsizing which is needed for a lot of Rust type magic
- Continuing progress on late name resolution issues and extern crate handling

** Completed Activities

- gccrs: Small fixes for #[repr(transparent)]                          [[https://github.com/rust-gcc/gccrs/pull/4716][PR4716]]
- gccrs: Fix deriving with generic const args                          [[https://github.com/rust-gcc/gccrs/pull/4715][PR4715]]
- gccrs: Record dirty state of `GlobbingVisitor`                       [[https://github.com/rust-gcc/gccrs/pull/4713][PR4713]]
- ci: Avoid trying to send emails on forked repos                      [[https://github.com/rust-gcc/gccrs/pull/4706][PR4706]]
